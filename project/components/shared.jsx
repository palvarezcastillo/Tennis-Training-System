...
// Shared components: TennisPlayer, RingChart, MiniBar, Icon
// Exported to window for cross-script use

const TennisPlayer = ({ size = 100, color = "#d4501a", opacity = 1 }) => (
...
const RingChart = ({ value, max, color, size = 64, strokeWidth = 7, children }) => {
...
const MiniBar = ({ value, max, color = "#d4501a" }) => (
...
Object.assign(window, { TennisPlayer, RingChart, MiniBar, Icon });
